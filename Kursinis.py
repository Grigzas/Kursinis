    ...
    def move(cls):
            ...
            if text != "":
                if text == "1":
                    ...
                    if sk == [] or raide == []:
                        print("Netinkamos koordinatės")
                        Game.move()
                    elif sk[0] != 3 and sk[0] != 2 and sk[0] != 1:
                        print("Netinkamos koordinatės")
                        Game.move()
                    elif raide[0] != "A" and raide[0] != "B" and raide[0] != "C":
                        print("Netinkamos koordinatės")
                        Game.move()
            if text == "1":
                return
